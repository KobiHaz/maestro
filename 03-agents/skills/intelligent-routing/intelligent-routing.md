...
| **Game**        | unity, godot, phaser, game, multiplayer    | `game-developer` [[games/README]] |
...
### With Agent Routing Rules

- **Priority**: `03-agents/agent-routing.md` rules > intelligent-routing
- If agent-routing specifies explicit routing, follow it
...
Add to agent routing or system instructions temporarily:
...
**Next Steps**: Integrate this skill into agent-routing or CLAUDE.md when automatic routing is desired.
