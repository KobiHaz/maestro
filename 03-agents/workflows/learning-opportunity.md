...
Pause development mode. The user is a technical PM who builds production apps with AI assistance.

**Tools in vault:** Reference technical docs in `04-knowledge/`. Relevant specialists in `03-agents/specialists/` for domain context. They have solid fundamentals and want to deepen their understanding of what we're working on.
