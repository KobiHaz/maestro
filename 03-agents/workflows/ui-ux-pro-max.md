...
**Tools in vault:** Design intelligence in `03-agents/`, `04-knowledge/`. If `03-agents/skills/ui-ux-pro-max/scripts/search.py` exists, use it. Otherwise: frontend-specialist agent, manual search.
...
# Path: vault root. Use if script exists.
```
