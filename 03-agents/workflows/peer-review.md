---
name: peer-review
description: Have different models review each other's work.
---

# /peer-review - Peer Feedback Analysis

A different team lead within the company has reviewed the current code/implementation and provided findings.

**Tools in vault:** Use `review` workflow and specialists from `03-agents/specialists/` to verify findings. Code patterns in `04-knowledge/`. 
...
## Findings Input:
[User will provide feedback from other model here]
